...
| [Association Rules / Market Basket Analysis](Association-Rules.md) | [Sample App - NER and Association Rules](Sample-App-NER-Apriori.qvf) | If using Qlik Sense Desktop you will need to download the [data sources](LOTR/), create a data connection named `AttachedFiles` in the app, and point the connection to the folder containing the source files. |
